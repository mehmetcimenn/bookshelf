    ...
    <div>
        ...
        <table className="table">
          <thead>
            <tr>
              ...
              <th scope="col">Kayıtlı Kİtap Sayısı</th>
      ...
      {openDeleteModal === true && (
        <CustomModal
          ...
          message="Kategor ile beraber ilgili bütün kitaplar da silinecektir. Bu işlemi yapmak istediğinize emin misiniz?"
